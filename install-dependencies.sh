...
wget https://releases.hashicorp.com/packer/1.2.5/packer_1.2.5_linux_amd64.zip -O packer_1.2.5_linux_amd64.zip ; sudo unzip -d /usr/bin/ packer_1.2.5_linux_amd64.zip ; rm -rf packer_1.2.5_linux_amd64.zip
